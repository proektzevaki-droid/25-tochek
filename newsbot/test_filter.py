...
# отметил как нужные. Всё остальное — ненужное. Новая пара добавляется
# отдельной строкой и сюда, и в config.yaml.
UAONLINE_PAIRS = [
    "🤬, 😁",
    "🤬, 🙏",
    "🤬, 😢",
...
for pairs in ((("👍", 800), ("🔥", 400)), (("🤬", 900), ("👍", 300)), (("❤️", 500), ("🙏", 200))):
    label = pairs[0][0] + pairs[1][0]
    check(f"{label} не из списка → пропускаем", evaluate(post(*pairs), uaonline, 0, 0)[0], False)
